...
Instance: ex-MHV-chPanel-1190740001a
...
* hasMember = Reference(ex-MHV-chTest-1190740001a)
...
* contained[+] = ex-MHV-chPanel-1190740001a
* result[+] = Reference(ex-MHV-chPanel-1190740001a)
...
* meta.lastUpdated = 2019-03-15T16:59:36-05:00
