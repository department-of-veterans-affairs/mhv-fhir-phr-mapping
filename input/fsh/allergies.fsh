...
* -> "HDR Allergy" "eVault"
* identifier -> "intoleranceCondition.recordIdentifer"
* code.text -> "intoleranceCondition.agent.code" "Allergen"
...
* reaction.manifestation.text -> "intoleranceCondition.reaction.reaction.displayText" "Reactions"
* note -> "intoleranceCondition.commentEvents"
* note.text -> "intoleranceCondition.commentEvents.comment" "Comments"
* note.time -> "~intoleranceCondition.commentEvents.date.literal"
