...
* type.coding -> "NoteTO.type{PN, DS, CR, ?}" "8925-.01 - DOCUMENT TYPE"
* context.related -> "GetLocation(NoteTO.location.[HospitalLocationTO])" "8925-1211 - VISIT LOCATION"
...
* authenticator.extension[when] -> "ConvertDate(NoteTO.procTimestamp)" "8925-1304 - RELEASE DATE/TIME"
