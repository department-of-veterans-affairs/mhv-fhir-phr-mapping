This is a sample of a note that was signed, and for which an addenda is added and signed. This is the update of [note-5](DocumentReference-ex-MHV-note-5.html), note only the body text changes.
