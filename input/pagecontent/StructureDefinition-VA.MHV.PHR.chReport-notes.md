...
- The [mock example](https://github.com/JohnMoehrke/MHV-PHR/blob/main/mocks/hdr_lab_sample.xml) 
...
- should have `meta.profile` set to `https://johnmoehrke.github.io/MHV-PHR/StructureDefinition/VA.MHV.PHR.chReport` to indicate the intent to be compliant with this profile
